...
#include <SPI.h>
//---------------修改此处""内的信息---------------------------------------------
const char ssid[] = "nova 5 Pro";                       //WiFi名
const char pass[] = "asswecan";                   //WiFi密码
static const char ntpServerName[] = "ntp.bupt.edu.cn"; //NTP服务器，北京邮电大学
...
int years, months, days, hours, minutes, seconds, weekdays,judge=0;
void setup()
{
    Serial.begin(9600);
    while (!Serial)
...
void loop()
{
   ...
   if (hours==7&&minutes==30)//修改闹钟时间
    {
       Serial.printf("ringing!");
       //digitalWrite(8,HIGH);
       judge =1;
       delay(1000);
       //digitalWrite(3,HIGH);
